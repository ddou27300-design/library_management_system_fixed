...
@section('page-title', 'Popular Books')
...
<div class="card">
    <div class="card-header">
        <h3><i class="fas fa-fire fire-icon"></i> Most Borrowed Books</h3>
        <span style="font-size:.85rem;color:var(--text-muted)">{{ $books->total() }} books ranked</span>
    </div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        @if($book->isbn)
                            <br><small class="text-muted text-mono">ISBN: {{ $book->isbn }}</small>
                        @endif
                    </td>
                    <td>{{ $book->author ?? '—' }}</td>
                ...
                <tr>
                    <td colspan="7" class="text-center text-muted" style="padding:40px">
                        ...
                        No borrow records yet. Issue some books to see popularity stats.
                    </td>
                </tr>
                @endforelse
            </tbody>
